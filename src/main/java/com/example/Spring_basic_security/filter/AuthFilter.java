package com.example.Spring_basic_security.filter;


import com.example.Spring_basic_security.service.JWTService;
import com.example.Spring_basic_security.service.RequestEntityRequestDetails;
...
public class AuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(userName!=null  && SecurityContextHolder.getContext().getAuthentication() == null){
            UserDetails userDetails= requestEntityUserDetailsService.loadUserByUsername(userName);
